...
const getRemarks = (percentage: number) => {
  if (percentage >= 80) return 'Superb! Amazing! **';
  if (percentage >= 70) return 'Excellent Work!';
  if (percentage >= 60) return 'Good!';
  if (percentage >= 50) return 'Satisfactory, can do better.';
  if (percentage >= 40) return 'Pass. Requires hard work.';
              ...
              <div key={student.id} className="flex flex-col gap-8 print:block print:gap-0">
                    ...
                    <div className="relative z-10 flex flex-col h-full flex-1">
                      ...
                      <div className="text-center mb-6">
                        ...
                        <div className="inline-block bg-blue-900 text-white font-bold px-6 py-1 rounded-sm text-lg">
                          Gondlanwala Road Gala Shazia Hospital Wala Dhullay Guranwala +923007412320
                        </div>
                      </div>
                ...
                <div className="text-blue-900 font-bold text-sm mb-4 flex flex-col gap-3">
                  ...
                  <div className="flex items-end">
                    ...
                    <span className="flex-1 border-b border-dotted border-blue-900 mx-2 relative top-[-4px] text-black">
                      {!isSample && term.totalMaxMarks > 0 ? getRemarks(term.percentage) : ''}
                    </span>
                  </div>
                </div>
